...
<div class="wrapper">
    ...
    <?php
        include "modulos/entorno-seleccion.php";
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Selección Entorno</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="container" style="padding-top: 0px;">
                <?php if ($procesar=="ok") {  ?>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-8">
                            <p class="lead">
                                <b>Bienvenido</b>, esta vista solo la pueden ver los Administradores de la aplicación.
                                Para poder ver los movimientos de una empresa primero debes seleccionarla en el menú desplegable que se presenta a continuación.
                                <strong>Si no seleccionas una empresa, los datos no serán visibles y algunas opciones de la aplicación no estarán disponibles.</strong>
                            </p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            <form action="entorno-seleccion.php" method="post">
                                <div class="">
                                ...
                                <div class="row">
                                    <!-- <input type="submit" class="btn btn-primary" name="btn_accion" value="Guardar"> -->
                                        ...
                                        <div class="col-md-4">
                                            <input type="submit" class="btn btn-primary btn-block" name="btn_accion" value="Seleccionar">
                                        </div>
