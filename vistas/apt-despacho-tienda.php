                    ...
                    <?php if ($procesar=="ok") {  ?>
                        ...
                        <!-- Íconos Generales -->
                            ...
                            <?php if ($txtUsuarioTipo!="A") {?>
                                ...
                                <a href=""type="button" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Ajuste</a>
                            <?php }?>
                                            ...
                                            <form action="despacho.php" method="post">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <?php if($movimientos=="SI") { ?>
                                                        <div class="col-md-4">
                                                            <a href="despacho.php" type="button" class="btn btn-primary btn-block"><i class="fas fa-plus-circle"></i> Nuevo Despacho</a>
                                                        </div>
                                                    <?php } ?>
                                                </div>
                                            </form>
