            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-3">
                    <div class="form-group" style="padding-top: 20px;">
                        ...
                        <input type="text" class="form-control" id="txt-nombre" placeholder="Nombre Operador" value="">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group" style="padding-top: 20px;">
                        <label for="txt-cargo">Cargo</label>
                        <input type="text" class="form-control" id="txt-cargo" placeholder="Cargo" value="">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group" style="padding-top: 20px;">
                        <label for="num-horassemana">Total Horas Semanales</label>
                        <input type="number" class="form-control" id="num-horassemana" placeholder="" value="0.00">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group" style="padding-top: 20px;">
                        <label for="num-horasxsemana">Max. Hr. por semana</label>
                        <input type="number" class="form-control" id="num-horasxsemana" placeholder="" value="0.00">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group" style="padding-top: 20px;">
                        <label for="txt-empresa">Empresa</label>
                        <input type="text" class="form-control" id="txt-empresa" placeholder="Nombre Empresa" value="">
                    </div>
                </div>
            ...
            <div class="row" style="padding: 0px 0px 0px 0px;">
                <div class="col-12">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><b>Movimientos PCM-MOD Operador</b></h3>
